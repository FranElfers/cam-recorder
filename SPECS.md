...
* Execution: Run the program as a systemd service.
* Primary Language: Go.
...
## 4. File Management
* Use the `github.com/robfig/cron/v3` library for scheduled tasks.
* Compress video files that are older than 48 hours. Use the H.265 codec.
...
* Transcode the RTSP stream to HLS format for the live video feed.
...
* Use standard libraries or established packages to decrease the token count.
